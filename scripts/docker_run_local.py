...
#
#
# THIS IS HORRIBLY INSECURE! DO NOT USE THIS!
...
# Executing this will also generate mkenv.py and env.json.
# Those can be used to set your shell environment up with the
# task's environment. Very helpful for running individual
# steps of a job without running the whole thing.
